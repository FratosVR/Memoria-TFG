...
Todos los modelos de los que se hablarán en esta sección son modelos que usan imágenes como entrada. No se ha encontrado modelo público que use datos de un traje de captura de movimiento como entrada.
