...
\section{Objetivos}
Implementación de un modelo de \gls{ia} que, con baja latencia, permita identificar el gesto que se esté realizando con un traje de captura de movimiento en tiempo real. También se busca crear un dataset de gestos compuesto por animaciones de usuarios reales y de animaciones creadas por ordenador.
