...
Este modelo finalmente es exportable a TensorFlow, siendo esto muy útil para su desplegado y compatibilización con otras herramientas

\subsection{Hardware y sus suplicios}

HABLAR DE LA FALTA DE TIEMPO POR CULPA DE TENER POCOS RECURSOS

\subsection{TensorFlow Serving}

HABLAR  DE LO GUAPO QUE ESTA TF SERVING CON LA COMPATIBILIDAD CON YDF