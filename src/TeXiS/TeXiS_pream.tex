...
\ifx\generaacronimos\undefined
  ...
  \newcommand{\acf}[1]{#1}
\else
  \usepackage[nonumberlist,toc,nopostdot,style=long,hyperfirst=true, automake, shortcuts]{glossaries-extra}
...
\DefTblrTemplate{contfoot-text}{default}{Continua en la siguiente página}
...
\hypersetup{
  ...
  urlcolor=cyan,
  citecolor=teal,
  pdftitle={Análisis de captura de movimiento para
      inferencia de la comunciación no verbal},
